// import { messageItemTemplate } from './templates';
...
export default class MessageList {
  ...
  add(from, text) {
    ...
    // const template = handlebars.compile(messageItemTemplate, { strict: true });
    // const result = template(sanitize, date, hours, minutes, time, item, from, text);
    // const result = template(time);
    // console.log(result);
