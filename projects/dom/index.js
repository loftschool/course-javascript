...
function createDivWithText(text) {
  const element = document.createElement('div'); //why const, not let?
...
function deleteTextNodesRecursive(where) {
  ...
  //   }
  // if (child.nodeType === 1) {
  //   for (const childEl of child.childNodes) {
  //     if (childEl.nodeType === 3) {
  //       childEl.parentNode.removeChild(child);
  //     }
  //   }
  // }
  // }
  for (let i = 0; i < where.childNodes.length; i++) {
    const elem = where.childNodes[i]; // она же меняется???
